...
Revision ID: 9195574867f1
Revises: 
Create Date: 2025-10-22 02:43:36.821380
...
def upgrade() -> None:
    ...
    op.create_index('idx_post_time', 'schedule_posts', ['time'], unique=False)
    ...
    op.create_index('idx_progress_date', 'user_progress', ['sent_date'], unique=False)
...
def downgrade() -> None:
    ...
    op.drop_index('idx_progress_date', table_name='user_progress')
    op.drop_table('user_progress')
    op.drop_index('idx_post_time', table_name='schedule_posts')
